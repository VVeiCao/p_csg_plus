...
parser.add_argument('--batch_size', type=int, default=20, help='Batch size for one GPU. When training with multiple GPUs the effective batch size will be batch_size*num_gpus')
parser.add_argument('--load_file', type=str, default="/home/cw/Desktop/physical-world-attack/transfuserp/transfuser+/model_ckpt/transfuser2/model_26.pth", help='ckpt to load.')
