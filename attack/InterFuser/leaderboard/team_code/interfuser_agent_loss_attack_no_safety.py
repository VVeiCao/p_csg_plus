...
class InterfuserAgent(autonomous_agent.AutonomousAgent):
    ...
    def run_step(self, input_data, timestamp):
        ...
        # attack model
        attack_model_front_dict = torch.load('/home/slt/gitlab_file/InterFuser/logs/loss_attack_interfuser_controller/run_2/30_front_ckpt.tar')
        attack_model_right_dict = torch.load('/home/slt/gitlab_file/InterFuser/logs/loss_attack_interfuser_controller/run_2/30_right_ckpt.tar')
        attack_model_left_dict = torch.load('/home/slt/gitlab_file/InterFuser/logs/loss_attack_interfuser_controller/run_2/30_left_ckpt.tar')
        attack_model_front_center_dict = torch.load('/home/slt/gitlab_file/InterFuser/logs/loss_attack_interfuser_controller/run_2/30_center_ckpt.tar')
