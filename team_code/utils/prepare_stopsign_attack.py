...
for num in num_list:
    ...
    client = carla.Client("localhost", 20002)
    client.set_timeout(client_timeout)
    traffic_manager = client.get_trafficmanager(20502)
    ...
    CarlaDataProvider.set_traffic_manager_port(20502)
...
#     traffic_manager.set_random_device_seed(0)
    ...
    for town_type in type_list:
        if num in [6, 7, 10] and town_type == "long":
            continue
