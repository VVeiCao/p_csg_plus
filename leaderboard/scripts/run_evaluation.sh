export CARLA_ROOT=${1:-/home/ubuntu/projects/p_csg_final/carla}
export WORK_DIR=${2:-/home/ubuntu/projects/p_csg_final}
...
export CHECKPOINT=${WORK_DIR}/results/v2_safety_box_t6.json
