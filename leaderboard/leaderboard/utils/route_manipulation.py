...
from agents.navigation.global_route_planner_dao import GlobalRoutePlannerDAO # 10->12
...
def interpolate_trajectory(world, waypoints_trajectory, hop_resolution=1.0):
    ...
    dao = GlobalRoutePlannerDAO(world.get_map(), hop_resolution) # 10->12
    grp = GlobalRoutePlanner(dao) # 10->12
    grp.setup()
    # Obtain route plan
    route = []
